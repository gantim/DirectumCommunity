...
namespace DirectumCommunity.Migrations
{
    ...
    [Migration("20240110204923_AddNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DirectumCommunity.Models.MeetingMember", b =>
                {
            ...
            modelBuilder.Entity("DirectumCommunity.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DirectumCommunity.Models.NotificationRead", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DirectumCommunity.Models.Meeting", b =>
                {
                    b.HasOne("DirectumCommunity.Models.Employee", "President")
                        .WithMany()
                        .HasForeignKey("PresidentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DirectumCommunity.Models.Employee", "Secretary")
                        .WithMany()
            ...
            modelBuilder.Entity("DirectumCommunity.Models.MeetingMember", b =>
                {
                    b.HasOne("DirectumCommunity.Models.Employee", "Employees")
                        .WithMany("MeetingMembers")
                        .HasForeignKey("EmployeesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DirectumCommunity.Models.Meeting", "Meetings")
                        .WithMany("MeetingMembers")
            ...
            modelBuilder.Entity("DirectumCommunity.Models.NotificationRead", b =>
                {
                    ...
                    b.HasOne("DirectumCommunity.Models.Notification", "Notification")
                        .WithMany()
